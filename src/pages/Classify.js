...
export default class Classify extends Component {
  ...
  constructor(props) {
    ...
    this.docRef = firebaseFirestore.collection("users");
  ...
  async componentDidMount() {
    ...
    this.docRef.doc(this.props.location.state.id).get().then( (doc) => {
      if (doc.exists) {
        
        this.setState({initialPoints: doc.data().points}, function(){
